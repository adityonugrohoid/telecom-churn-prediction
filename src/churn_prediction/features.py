...
class FeatureEngineer:
    ...
    def create_interaction_features(self, df: pd.DataFrame) -> pd.DataFrame:
        """
        Create domain-specific interaction features for churn prediction.

        Features capture subscriber engagement, network experience, and
        support burden signals that are predictive of churn behavior.
        ...
        if "total_sessions" in df.columns:
            df["session_frequency"] = df["total_sessions"] / 30
